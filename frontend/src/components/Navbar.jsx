...
function Navbar() {
  ...
  return (
    <>
      <div
        className={` max-w-screen-2xl container mx-auto bg-white md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
        ...
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            <div className="navbar-center hidden lg:flex">
              <ul className="menu menu-horizontal px-1 bg-base-100 text-xl font-mono ">
                {navItems}
              </ul>
            </div>
            ...
            {authUser ? (
              ...
              <div className="">
                <a
                  className="bg-green-700 text-white px-3 py-2 rounded-md hover:bg-green-800 duration-300 cursor-pointer "
                  onClick={() =>
