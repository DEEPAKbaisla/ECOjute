  ...
  switch (category?.toLowerCase()) {
    case "bags":
      return {
        ...
        features:
          "Reinforced base with solid brass feet, water-resistant interior lining.",
      };
    case "accessories":
      return {
        width: "8.5 in / 21 cm",
        ...
        handleDrop: "N/A",
        features:
          "Premium metal zipper closure, handcrafted matching wrist strap.",
      };
    case "home":
      return {
        width: "24 in / 60 cm",
        ...
        handleDrop: "N/A",
        features:
          "Natural non-slip rubber backing, hand-woven thick braid layout.",
      };
    default:
      return {
        width: "12 in / 30 cm",
  ...
  if (isError || !bag) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-6 text-center">
        <h2 className="font-serif text-3xl text-destructive mb-4">
          Bag Not Found
        </h2>
        ...
        <Link
          to="/products"
          className="bg-foreground text-background px-6 py-3 rounded-full hover:opacity-80 transition">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-8">
            <div className="space-y-4">
              ...
              <p className="font-serif text-2xl text-secondary font-semibold font-sans">
                ₹ {bag.price}
              </p>
            </div>

            <p className="text-foreground/85 text-base md:text-lg leading-relaxed font-semibold">
              {bag.description ||
                "Designed for the intentional wanderer. This exclusive piece merges the raw structural integrity of hand-woven organic jute with the premium durability of ethical finishes. Perfect for daily lifestyle use, carrying heritage and dedication."}
            </p>

            {/* Config & Info */}
            <div className="space-y-4 pt-4 border-t border-border">
              <div className="flex items-center gap-4">
                <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground w-24">
                  Material
                </span>
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-card border border-border rounded-md text-xs font-medium text-foreground shadow-sm">
                    Organic Jute
                  </span>
                  <span className="px-3 py-1 bg-card border border-border rounded-md text-xs font-medium text-foreground shadow-sm">
                    Eco Fibers
              ...
              <div className="flex items-center gap-4">
                ...
                <span
                  className={`text-sm font-medium ${bag.stock ? "text-emerald-600 dark:text-emerald-400" : "text-destructive"}`}>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center px-6 md:px-12">
            ...
            <div className="space-y-6 order-1 md:order-2">
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                />
                <div>
                  <h4 className="font-serif text-lg text-foreground italic font-semibold">
                    {artisan.name}
                  </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="space-y-4 p-6 bg-card rounded-3xl border border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed font-semibold">
                Untreated jute fibers that return to the earth naturally without
                leaving a synthetic trace.
              </p>
            </div>
            ...
            <div className="space-y-4 p-6 bg-card rounded-3xl border border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed font-semibold">
                Natural indigo and organic dyes that gather premium character
                and patina with every year of use.
              </p>
            </div>
            ...
            <div className="space-y-4 p-6 bg-card rounded-3xl border border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed font-semibold">
                We support a lifetime weaving restoration service to ensure your
                carrier lasts for generations.
              </p>
            </div>
          </div>
        </section>
